# Title: DC House Appraisals Analysis
...
appraisals = pd.read_csv("DC-House-Appraisals-Data.csv")
...
sr_corr_inputs["ttl_bathrms"] = sr_corr_inputs["ttl_bathrms"].map({ 
  "1": 1, "1.5": 2, "2": 3, "2.5": 4, "3": 5, "3.5": 6, "4 or More": 7 
  })
sr_corr_inputs["fireplaces"] = sr_corr_inputs["fireplaces"].map({ 
  "0": 1, "1": 2, "2 or More": 3 
  })
...
sr_corr_inputs["rooms"] = sr_corr_inputs["rooms"].map({ 
  "5 or Fewer": 1, "6": 2, "7": 3, "8": 4, "9": 5, "10 or More": 6 
  })
sr_corr_inputs["age"] = sr_corr_inputs["age"].map({ 
  "10 or Fewer": 1, "11 to 60": 2, "61 to 70": 3, "71 to 80": 4, 
   "81 to 90": 5, "91 to 100": 6, "101 to 110": 7, "111 or More": 8 
   })   
sr_corr_inputs["landarea"] = sr_corr_inputs["landarea"].map({ 
  "999 or Fewer": 1, "1,000 to 1,999": 2, "2,000 to 4,999": 3, 
  "5,000 or More": 4 
  })
...
knn_best_hp = GridSearchCV(
  ...
  param_grid = {"n_neighbors": [13, 14, 15], 
